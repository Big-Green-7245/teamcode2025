...
public class RobotConfig {
    ...
    private void initDriveMotors() {
        ...
        testyTesty = hwMap.get(DcMotor.class, Constants.TESTY);
        ...
        testyTesty.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
